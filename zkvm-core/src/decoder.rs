//! RISC-V instruction decoder for the zkVM.
...
pub enum BlanchKind { Beq, Bne, Blt, Bge, Bltu, Bgeu }
...
pub fn decode(word: u32) -> Result<Instruction, DecodeError> {
    ...
    match opcode {
        ...
        0x13 => {
            ...
            let rd = rd(word); let rs1 = rs1(word);
            match funct3(word) {
                ...
                0x1 | 0x5 => {
                    ...
                    match (funct3(word), funct7(word)) {
                        ...
                        _ => Err(DecodeError { word, reason: "invalid shift imm encoding" }),
                    }
                }
        ...
        0x33 => {
            ...
            match (funct7(word), funct3(word)) {
                ...
                (AK
HOˆÚÊ[œÝXÝ[ÛŽŽ“][ÈÜˆ][ÜŽ“][™œÌKœÌˆJKˆ
GƒÂƒ’Óâö²„–ç7G'V7F–öã£¤×VÂ²÷¢×VÄ÷£¤×VÆ‚Â&BÂ'3Â'3"Ò’À¢ƒƒÂƒ"’Óâö²„–ç7G'V7F–öã£¤×VÂ²÷¢×VÄ÷£¤×VÆ†7RÂ&BÂ'3Â'3"Ò’À¢„àÀÄ°€ÁàÌ¤€ôø=¬¡%¹ÍÑÉÕÑ¥½¸èé5Õ°ì½Àè5Õ±=Àèé5Õ±¡Ô°É°ÉÌÄ°ÉÌÈô¤°(€€€€€€€€€€€€€€€€ ÁàÀÄ°€ÁàÐ¤€ôø=¬¡%¹ÍÑÉÕÑ¥½¸èé5Õ°ì½Àè5Õ±=Àèé¥Ø°É°ÉÌÄ°ÉÌÈô¤°(€€€€€€€€€€€€€€€€ ÁàÀÄ°€ÁàÔ¤€ôø=¬¡%¹ÍÑÉÕÑ¥½¸èé5Õ°ì½Àè5Õ±=Àèé¥ÙÔ°É°ÉÌÄ°ÉÌÈô¤°(€€€€€€€€€€€€€€€€ ÁàÀÄ°€ÁàØ¤€ôø=¬¡%¹ÍÑÉÕÑ¥½¸èé5Õ°ì½Àè5Õ±=ÀèéI•´°É°ÉÌÄ°ÉÌÈô¤°(€€€€€€€€€€€€€€€€¡x01, 0x7) => Ok(Instruction::Mul { op: MulOp::Remu, rd, rs1, rs2 }),
