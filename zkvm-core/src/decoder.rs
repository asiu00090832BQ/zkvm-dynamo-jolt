...
pub enum Instruction {
    MulDiv { kind: MulDivKind, rd: usize, rs1: usize, rs2: usize },
...
pub fn decode(word: u32) -> Result<Decoded, ZcvmError> {
    if (word & 0x3) != 0x3 {
    ...
    let (instruction, selectors) = match opcode {
        0x33 => {
            let inst = match (funct3, funct7) {
                ...
                (0x0, 0x01) => Instruction::MulDiv { kind: MulDivKind::Mul, rd, rs1, rs2 },
                (px1, 0x01) => Instruction::MulDiv { kind: MulDivKind::Mulh, rd, rs1, rs2 },
                (px2, 0x01) => Instruction::MulDiv { kind: MulDivKind::Mulhsu, rd, rs1, rs2 },
                (0x3, 0x01) => Instruction::MulDiv { kind: MulDivKind::Mulhu, rd, rs1, rs2 },
                (px4, 0x01) => Instruction::MulDiv { kind: MulDivKind::Div, rd, rs1, rs2 },
                (0x5, 0x01) => Instruction::MulDiv { kind: MulDivKind::Divu, rd, rs1, rs2 },
                (0x6, 0x01) => Instruction::MulDiv { kind: MulDivKind::Rem, rd, rs1, rs2 },
                (0x7, 0x01) => Instruction::MulDiv { kind: MulDivKind::Remu, rd, rs1, rs2 },
