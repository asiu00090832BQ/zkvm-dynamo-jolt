...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum ShiftImmKind { Sll, Srl, Sra }
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
...
pub enum Instruction {
    ...
    OpImmShift { kind: ShiftImmKind, rd: Register, rs1: Register, shamt: u8 },
    Op { kind: OpKind, rd: Register, rs1: Register, rs2: Register },
    MulDiv { kind: MulDivKind, rd: Register, rs1: Register, rs2: Register },
